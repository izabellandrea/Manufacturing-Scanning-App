...
class HomeInherit(Home):
    ...
    def _login_redirect(self, uid=None, redirect=None):
        if request.env['res.users'].sudo().browse(uid).has_group('mrp_scanning.scan_group_user'):
            redirect = '/scan'
...
class ScanningPage(http.Controller):
    ...
    def scan_page(self, **kwargs):
        return request.render('mrp_scanning.scan_template')
    ...
    def select_page(self, **kwargs):
        ...
        return http.request.render('mrp_scanning.select_template', {
            'mo_id' : mo_id,
    ...
    def work_page(self, **kwargs):
        ...
        return http.request.render('mrp_scanning.work_template', {
            'manufacturing_order': manufacturing_order,
